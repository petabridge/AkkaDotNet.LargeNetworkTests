...
namespace AkkaDotNet.Infrastructure.Logging
{
    public static class SerilogConfigurationExtensions
    {
        ...
        public static AkkaConfigurationBuilder WithSerilog(this AkkaConfigurationBuilder builder,
            SerilogOptions options)
        {
            var loggerConfiguration = new LoggerConfiguration()
                ...
                .Filter.ByExcluding(ExcludeHealthChecksNormalEvents).MinimumLevel
                .Debug(); // Do not want lots of health check info logs in console
            ...
            if (options.EnableSeq)
            {
                ...
                loggerConfiguration = loggerConfiguration
                    ...
                    .Filter
                    .ByExcluding(ExcludeHealthChecksNormalEvents); // Do not want lots of health check info logs in Seq
            }
