...
using OpenTracing.FrontEnd.Actors;
...
namespace OpenTracing.FrontEnd;
    ...
    public static async Task Main(string[] args)
    {
        var host = new WebHostBuilder()
            ...
            .ConfigureServices( (context, services) =>
            {
                ...
                // sets up Akka.NET
                services.AddAkka(ActorSystemConstants.ActorSystemName, (configurationBuilder, provider) =>
                {
                    ...
                    if (akkaConfiguration.DistributedPubSubOptions.Enabled)
                    {
                        ...
                        configurationBuilder.StartActors((system, registry) =>
                        {
                            ...
                            {
                                system.ActorOf(Props.Create(() => new PingerActor(tracer)), "pinger");
                            });
                        });
                    }
                });
